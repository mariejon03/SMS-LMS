...
<head>
    ...
    <style>
        .sidenav-nav .nav-title {
            padding: 10px 20px;
            margin-top: 15px;
            font-size: 0.8em;
            font-weight: bold;
            color: #8a99af; /* Muted text color for the title */
                ...
                <ul>
                    ...
                    <li class="nav-title">Academic Management</li>
                     <li class="<?php if ($active_page == 'subjects') echo 'active'; ?>">
                        <a href="../ClassPortal/index.php"><i class="fa-solid fa-book"></i> Class Portal</a>
                    </li>
                    ...
                    <li><a href="../FeedbackandComments/feedbackandcomments.php"><i class="fa-solid fa-comments"></i> Feedback & Comments</a></li>
